    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-primary">Update Sale Information</h6>
            </div>
            <div class="card-body">
                <?php echo form_open('sales/edit/'.$sale['id'], ['class' => 'needs-validation', 'novalidate' => '']); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo form_dropdown(
                                ...
                                set_value('product_id', $sale['product_id']),
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="customer_name" name="customer_name"
                                   value="<?php echo set_value('customer_name', $sale['customer_name']); ?>"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="quantity_sold" name="quantity_sold"
                                   value="<?php echo set_value('quantity_sold', $sale['quantity_sold']); ?>"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="unit_price" name="unit_price"
                                   value="<?php echo set_value('unit_price', $sale['unit_price']); ?>"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="sale_date" name="sale_date"
                                   value="<?php echo set_value('sale_date', $sale['sale_date']); ?>"
                                   required>
                            <div class="invalid-feedback">
                ...
                <div class="form-group">
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <span class="h4 text-success" id="totalAmount">
                                    $<?php echo number_format($sale['quantity_sold'] * $sale['unit_price'], 2); ?>
                                </span>
                            </p>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <ul class="list-unstyled">
                    <li class="mb-2">
                        ...
                        <small class="ml-2">Verify the selected product before saving</small>
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-user text-primary"></i>
                        <small class="ml-2">Double-check customer details</small>
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-sort-numeric-up text-warning"></i>
                        <small class="ml-2">Ensure correct quantity sold</small>
                    </li>
                    <li class="mb-0">
                        <i class="fas fa-dollar-sign text-success"></i>
                        <small class="ml-2">Total will update automatically if you change values</small>
                    </li>
                </ul>
            </div>
        </div>
