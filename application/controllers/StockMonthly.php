...
class StockMonthly extends CI_Controller {
    ...
    public function add() {
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('stock/monthly/add', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id) {
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('stock/monthly/edit', $data);
        $this->load->view('templates/footer');
    }
